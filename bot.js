  ...
  if (message.content.toLowerCase().startsWith(prefix + `help`)) {
   ...
   if (message.content.toLowerCase().startsWith(prefix + `commands`)) {
    ...
    .setDescription(`Here is a list of all available commands`)
		...
		.addField(`Add A Member`, `[${prefix}add @User#1234] > Adds the mentioned user to the current Support Ticket \`Example: ${prefix}add @Tyler. H#9393\`n\[${prefix}h add] > Shows you how to add a member to the current ticket `)
		.addField(`Remove A Member`, `[${prefix}remove @User#1234] > Adds the mentioned user to the current Support Ticket \`Example: ${prefix}remove @Tyler. H#9393\`n\[${prefix}h add] > Shows you how to remove a member from the current ticket `)
